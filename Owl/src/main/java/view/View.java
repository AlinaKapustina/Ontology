...
public class View extends JPanel {
    ...
    JTextField startTextMessange;
    JTextField finishTextMessange;
    JTextField startTextCall;
    JTextField finishTextCall;
    JTextField startTextInternet;
    JTextField finishTextInternet;
    ...
    private JPanel createMessangePanel() {
        ...
        startTextMessange = new JTextField();
        startPanel.add(start);
        startPanel.add(startTextMessange);

        JPanel finishPanel = new JPanel(new GridLayout(1, 2, 0, 0));
        JLabel finish = new JLabel("до");
        finishTextMessange = new JTextField();
        finishPanel.add(finish);
        finishPanel.add(finishTextMessange);

        start.setSize(new Dimension(20, 40));
        start.setBounds(0, 0, 20, 40);
        finish.setSize(new Dimension(20, 40));
        finish.setBounds(0, 0, 20, 40);
        startTextMessange.setSize(new Dimension(20, 40));
        startTextMessange.setBounds(0, 0, 20, 40);
        finishTextMessange.setSize(new Dimension(20, 40));
        finishTextMessange.setBounds(0, 0, 20, 40);
        data.add(startPanel);
    ...
    private JPanel createCallPanel() {
        ...
        JLabel start = new JLabel("от");
        startTextCall = new JTextField();
        JLabel finish = new JLabel("до");
        finishTextCall = new JTextField();
        start.setSize(new Dimension(20, 40));
        start.setBounds(0, 0, 20, 40);
        finish.setSize(new Dimension(20, 40));
        finish.setBounds(0, 0, 20, 40);
    ...
    private JPanel createInternetPanel() {
        ...
        data.setBounds(50, 50, 100, 50);
        JLabel start = new JLabel("от");
        startTextInternet = new JTextField();
        JLabel finish = new JLabel("до");
        finishTextInternet = new JTextField();
        start.setSize(new Dimension(20, 40));
        start.setBounds(0, 0, 20, 40);
        finish.setSize(new Dimension(20, 40));
        finish.setBounds(0, 0, 20, 40);
